...
# Studio99 MVP PWA Guidelines

- **Project Core**: Studio99 is an Agency Operating System and Client Portal (not a marketplace).
- **Tech Stack**: Laravel 11, React, Inertia.js, Tailwind CSS, PostgreSQL.
- **Timeline**: 10-day strict timeline for MVP.
