...
export default function AssignedTasks() {
  ...
  return (
    <TeamLayout>
      <Head title="Assigned Tasks | Team Dashboard" />

      {/* Page Header */}
      <div className="flex flex-col xl:flex-row xl:items-start justify-between gap-4 mb-8">
        <div>
          <h1 className="text-3xl font-gilroy font-bold text-text-primary mb-2">My Assigned Tasks</h1>
          <p className="text-text-secondary text-sm">Manage and track tasks assigned to you across projects.</p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-6 mb-8">
        <div className="bg-bg-surface border border-bg-border rounded-2xl p-6 shadow-sm hover:border-blue-500/30 transition-colors">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-text-secondary text-sm font-medium mb-1">Total Assigned</p>
              <div className="flex flex-wrap items-baseline gap-x-3 gap-y-1">
                <h3 className="text-2xl font-gilroy font-bold text-text-primary leading-none">12</h3>
              </div>
            </div>
          </div>
        </div>

        <div className="bg-bg-surface border border-bg-border rounded-2xl p-6 shadow-sm hover:border-amber-500/30 transition-colors">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="flex flex-wrap items-baseline gap-x-3 gap-y-1">
                <h3 className="text-2xl font-gilroy font-bold text-text-primary leading-none">3</h3>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-bg-surface border border-bg-border rounded-2xl p-6 shadow-sm hover:border-brand-red/30 transition-colors">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-brand-red/10 flex items-center justify-center shrink-0 border border-brand-red/20">
        ...
        <div className="bg-bg-surface border border-bg-border rounded-2xl p-6 shadow-sm hover:border-emerald-500/30 transition-colors">
          <div className="flex items-center gap-4">
