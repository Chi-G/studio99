        ...
        <div className="min-h-screen bg-bg-base flex flex-col justify-center items-center py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-md w-full space-y-8 bg-bg-card border border-bg-border p-8 rounded-2xl">
                <div className="flex flex-col items-center">
                    ...
                    <h2 className="text-center text-3xl font-black text-text-primary">
                        Create New Password
                    </h2>
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full bg-bg-base border border-bg-border rounded-xl px-4 py-3 text-text-primary focus:outline-none focus:border-brand-red transition-colors opacity-50 cursor-not-allowed"
                                required
                                readOnly
                            />
                        ...
                        <div>
                            <label className="text-sm font-medium text-text-primary block mb-2">New Password</label>
                            <div className="relative">
                                <input
                                    type={showPassword ? 'text' : 'password'}
                                    value={data.password}
                                    onChange={(e) => setData('password', e.target.value)}
                                    className="w-full bg-bg-base border border-bg-border rounded-xl px-4 py-3 text-text-primary focus:outline-none focus:border-brand-red transition-colors pr-12"
                                    required
                                />
                                <button
                                    type="button"
